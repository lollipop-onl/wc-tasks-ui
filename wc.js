(() => {
  ...
  var a = class extends HTMLElement {
    ...
    _$ES(t3, i3, s5 = l) {
      ...
      if (h3 !== void 0 && s5.reflect === true) {
        const n7 = ((r4 = (e6 = s5.converter) === null || e6 === void 0 ? void 0 : e6.toAttribute) !== null && r4 !== void 0 ? r4 : o2.toAttribute)(i3, s5.type);
    ...
    _$AK(t3, i3) {
      ...
      if (n7 !== void 0 && this._$Ei !== n7) {
        ...
        this._$Ei = n7, this[n7] = a3(i3, t4.type), this._$Ei = null;
      }
    }
    requestUpdate(t3, i3, s5) {
      let e6 = true;
      t3 !== void 0 && (((s5 = s5 || this.constructor.getPropertyOptions(t3)).hasChanged || n2)(this[t3], i3) ? (this._$AL.has(t3) || this._$AL.set(t3, i3), s5.reflect === true && this._$Ei !== t3 && (this._$E_ === void 0 && (this._$E_ = /* @__PURE__ */ new Map()), this._$E_.set(t3, s5))) : e6 = false), !this.isUpdatePending && e6 && (this._$Ep = this._$EC());
    }
    async _$EC() {
  ...
  var x = (t3, i3, s5) => {
    ...
    if (l5 === void 0) {
      ...
      n7._$litPart$ = l5 = new N(i3.insertBefore(h2(), t4), t4, void 0, s5 != null ? s5 : {});
    }
  ...
  var C = (t3, i3) => {
    ...
    for (let i4 = 0; i4 < o6; i4++) {
      ...
      r4 += d2 === c ? s5 + n3 : p2 >= 0 ? (l5.push(o7), s5.slice(0, p2) + "$lit$" + s5.slice(p2) + e3 + y2) : s5 + e3 + (p2 === -2 ? (l5.push(void 0), i4) : y2);
    }
          ...
          if (g.test(l5.tagName)) {
            ...
            if (s6 > 0) {
              ...
              for (let i3 = 0; i3 < s6; i3++)
                l5.append(t4[i3], h2()), A.nextNode(), c2.push({ type: 2, index: ++r4 });
              l5.append(t4[s6], h2());
            }
          }
  ...
  function P(t3, i3, s5 = t3, e6) {
    var o6, n7, l5, h3;
    if (i3 === b)
      return i3;
    let d2 = e6 !== void 0 ? (o6 = s5._$Cl) === null || o6 === void 0 ? void 0 : o6[e6] : s5._$Cu;
    const u2 = r3(i3) ? void 0 : i3._$litDirective$;
    return (d2 == null ? void 0 : d2.constructor) !== u2 && ((n7 = d2 == null ? void 0 : d2._$AO) === null || n7 === void 0 || n7.call(d2, false), u2 === void 0 ? d2 = void 0 : (d2 = new u2(t3), d2._$AT(t3, s5, e6)), e6 !== void 0 ? ((l5 = (h3 = s5)._$Cl) !== null && l5 !== void 0 ? l5 : h3._$Cl = [])[e6] = d2 : s5._$Cu = d2), d2 !== void 0 && (i3 = P(t3, d2._$AS(t3, i3.values), d2, e6)), i3;
  }
  var V = class {
    constructor(t3, i3) {
    ...
    p(t3) {
      var i3;
      const { el: { content: s5 }, parts: e6 } = this._$AD, o6 = ((i3 = t3 == null ? void 0 : t3.creationScope) !== null && i3 !== void 0 ? i3 : l2).importNode(s5, true);
      A.currentNode = o6;
      let n7 = A.nextNode(), h3 = 0, r4 = 0, d2 = e6[0];
      for (; d2 !== void 0; ) {
        if (h3 === d2.index) {
          let i4;
          d2.type === 2 ? i4 = new N(n7, n7.nextSibling, this, t3) : d2.type === 1 ? i4 = new d2.ctor(n7, d2.name, d2.strings, this, t3) : d2.type === 6 && (i4 = new L(n7, this, t3)), this.v.push(i4), d2 = e6[++r4];
        }
  ...
  var N = class {
    constructor(t3, i3, s5, e6) {
      var o6;
      this.type = 2, this._$AH = w, this._$AN = void 0, this._$AA = t3, this._$AB = i3, this._$AM = s5, this.options = e6, this._$Cg = (o6 = e6 == null ? void 0 : e6.isConnected) === null || o6 === void 0 || o6;
    }
    get _$AU() {
      var t3, i3;
    ...
    T(t3) {
      ...
      if (((i3 = this._$AH) === null || i3 === void 0 ? void 0 : i3._$AD) === o6)
        ...
        const t4 = new V(o6, this), i4 = t4.p(this.options);
    ...
    A(t3) {
      ...
      let s5, e6 = 0;
      for (const o6 of t3)
        e6 === i3.length ? i3.push(s5 = new N(this.M(h2()), this.M(h2()), this, this.options)) : s5 = i3[e6], s5._$AI(o6), e6++;
  ...
  var S2 = class {
    constructor(t3, i3, s5, e6, o6) {
      this.type = 1, this._$AH = w, this._$AN = void 0, this.element = t3, this.name = i3, this._$AM = e6, this.options = o6, s5.length > 2 || s5[0] !== "" || s5[1] !== "" ? (this._$AH = Array(s5.length - 1).fill(new String()), this.strings = s5) : this._$AH = w;
    }
    get tagName() {
    ...
    _$AI(t3, i3 = this, s5, e6) {
      ...
      let n7 = false;
      if (o6 === void 0)
        t3 = P(this, t3, i3, 0), n7 = !r3(t3) || t3 !== this._$AH && t3 !== b, n7 && (this._$AH = t3);
      else {
        const e7 = t3;
        let l5, h3;
        for (t3 = o6[0], l5 = 0; l5 < o6.length - 1; l5++)
          h3 = P(this, e7[s5 + l5], i3, l5), h3 === b && (h3 = this._$AH[l5]), n7 || (n7 = !r3(h3) || h3 !== this._$AH[l5]), h3 === w ? t3 = w : t3 !== w && (t3 += (h3 != null ? h3 : "") + o6[l5 + 1]), this._$AH[l5] = h3;
      }
      n7 && !e6 && this.k(t3);
    }
    k(t3) {
  ...
  var n5 = (n7) => (e6) => typeof e6 == "function" ? ((n8, e7) => (window.customElements.define(n8, e7), e7))(n7, e6) : ((n8, e7) => {
    const { kind: t3, elements: i3 } = e7;
    return { kind: t3, elements: i3, finisher(e8) {
